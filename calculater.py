...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value=''
        Entry(width=17, bg='orange',font=('Arial Bold',28), textvariable=self.equation).place(x=0, y=0)

        Button(width=11, height=4, text='(', relief='flat', bg='skyblue', command=lambda:self.show('(')).place(x= 0, y=50)
        Button(width=11, height=4, text=')', relief='flat', bg='skyblue', command=lambda:self.show(')')).place(x=90, y=50)
        Button(width=11, height=4, text='%', relief='flat', bg='skyblue', command=lambda:self.show('%')).place(x=180, y=50)
        ...
        Button(width=11, height=4, text='_', relief='flat', bg='skyblue', command=lambda:self.show('_')).place(x=180, y=350)
        Button(width=11, height=4, text='+', relief='flat', bg='skyblue', command=lambda:self.show('+')).place(x=270, y=275)
        Button(width=11, height=4, text='-', relief='flat', bg='skyblue', command=lambda:self.show('-')).place(x=270, y=200)
        Button(width=11, height=4, text='/', relief='flat', bg='skyblue', command=lambda:self.show('/')).place(x=270, y=50)
        Button(width=11, height=4, text='x', relief='flat', bg='skyblue', command=lambda:self.show('*')).place(x=270, y=125)
        Button(width=11, height=4, text='=', relief='flat', bg='blue', command=self.solve).place(x=270, y=350)
        Button(width=11, height=4, text='C', relief='flat', bg='skyblue', command=self.clear).place(x=0, y=350) 
